...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
            ...
            public async Task SeedAsync()
            {
                ...
                await CheckRoles();
                var manager = await CheckUserAsync("1010", "Enver", "Aguilo", "enver_aguilo@hotmail.com", "829 881 9320", "Calle Luna Calle Sol", "Admin");
                var customer = await CheckUserAsync("2020", "Vladimir", "Guzman", "eaguilo.rd@gmail.com", "829 991 3920", "Calle Luna Calle Sol", "Customer");
        ...
        //        {
        //        // _dataContext.Owners.Add(new Owner { User = user });
        //            AddOwner("00111274486","Enver","Aguilo", "8298819320", "8298819320","La direccion del Owner");
        //            AddOwner("00111274487", "Vladimir", "Guzman", "8299919320", "8299919320", "La segunda direccion del Owner");
        //            AddOwner("00111274488", "Enver", "Aguilo", "8298819325", "8298812390", "La tercera direccion del Owner");
        //            await _context.SaveChangesAsync();
        //        }
        //    }
        ...
        //{
        //    _context.Owners.Add(new Owner { Address = address, CellPhone = cellPhone, FirstName = firstName
        //                                    , FixedPhone = fixedPhone, LastName = lastName, Document = document});
        //}
